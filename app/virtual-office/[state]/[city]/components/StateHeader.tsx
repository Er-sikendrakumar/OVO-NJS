...
function CityHeader({ state, stateSlug, city, citySlug, cities }: CityHeaderProps) {
    ...
    const handleCitySelect = (cityItem: City) => {
        router.push(cityItem.url);
    };
    ...
    return (
        <div className='max-w-screen-xl mx-auto lg:pt-[140px] pt-[100px] px-[16px] lg:px-[32px] flex flex-col gap-[24px]'>
            <div className='flex flex-row items-center gap-[8px]'>
                ...
                <Link href={`/virtual-office/${stateSlug}`} className='text-[#717680] font-inter font-semibold text-[14px] leading-[100%] tracking-[0]'>
                    {state}
                </Link>
                <ChevronRight className='w-[16px] h-[16px] min-w-[16px] min-h-[16px] text-[#A4A7AE]' />
            ...
            <div className='flex flex-col gap-[24px] '>
                <h1 className='text-[24px] lg:text-[36px] font-inter font-semibold leading-[120%] tracking-[-2%] text-[#101828]'>
                    Virtual Office Locations in {city}
                </h1>
