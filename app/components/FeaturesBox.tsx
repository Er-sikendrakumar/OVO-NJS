...
export const FeaturesBox = ({ features }: FeaturesBoxProps) => {
  return (
    <div className="inline-flex flex-col w-[400px] self-stretch items-start sm:gap-2.5 !gap-3 pl-0 pr-0 py-0">
      ...
      <div className="inline-flex flex-col items-start gap-3 sm:gap-3 w-full">
        {features.map((feature, index) => (
          <div
            key={index}
            className="inline-flex items-start !gap-3 sm:gap-2.5"
          ...
          >
            ...
            <div className="flex flex-col w-full items-start pt-0.5 pb-0 px-0">
              <p className="font-normal text-gray-600 text-[18px] tracking-[0] leading-[28px]">
                {feature}
              </p>
            </div>
          </div>
      ...
      <div className="flex flex-col items-end gap-2 w-full">
        <a href="/services/">
          <div
            className="flex items-center gap-2 cursor-pointer lg:pr-5"
