              ...
              >
                ...
                <div className="flex flex-col gap-2 px-4 pt-3 pb-5 border border-[#EAECF0] border-t-0 rounded-b-[12px]">
                  <div className="order-2">
                    <h3 className="text-[16px] font-bold text-[#475467] leading-6">
                      {location.city}
                    </h3>
                    <p className="mt-1 text-[14px] text-[#475467] leading-5">
                      {location.addressLine1} {location.addressLine2}
                    </p>
                  </div>

                  <div className="text-center order-1">
                    <p className="font-bold text-[#17B26A] text-[12px] leading-[18px]">
                      {location.price}
                    </p>
                    <p className="uppercase text-[12px] font-bold leading-[18px]">
                      All-inclusive{" "}
