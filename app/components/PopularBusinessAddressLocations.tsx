...
const popularLocations: PopularLocation[] = [
  { name: "Atlanta, GA", image: "/atlanta.webp", href: "/business-address/georgia/atlanta/location-684/" },
  { name: "Austin, TX", image: "/austin.webp", href: "/business-address/texas/austin/location-1475/" },
  { name: "Beverly Hills, CA", image: "/beverly-hills.webp", href: "/business-address/california/beverly-hills/location-936/" },
  { name: "Boca Raton, FL", image: "/boca-raton.webp", href: "/business-address/florida/boca-raton/location-776/" },
  { name: "Brooklyn, NY", image: "/brooklyn.webp", href: "/business-address/new-york/brooklyn/location-1477/" },
  { name: "Chicago, IL", image: "/chicago.webp", href: "/business-address/illinois/chicago/location-1430/" },
  { name: "Dallas, TX", image: "/dallas.webp", href: "/business-address/texas/dallas/location-1255/" },
  { name: "Fort Lauderdale, FL", image: "/fort-lauderdale.webp", href: "/business-address/florida/fort-lauderdale/location-803/" },
  { name: "Houston, TX", image: "/houston.webp", href: "/business-address/texas/houston/location-1323/" },
  { name: "Los Angeles, CA", image: "/los-angeles.webp", href: "/business-address/california/los-angeles/location-1362/" },
  { name: "Miami, FL", image: "/miami.webp", href: "/business-address/florida/miami/location-1285/" },
  { name: "Nashville, TN", image: "/nashville.webp", href: "/business-address/tennessee/nashville/location-1476/" },
  { name: "New York, NY", image: "/new-york.webp", href: "/business-address/new-york/new-york/location-1450/" },
  { name: "Orlando, FL", image: "/orlando.webp", href: "/business-address/florida/orlando/location-1499/" },
  { name: "Tampa, FL", image: "/tampa.webp", href: "/business-address/florida/tampa/location-885/" },
  { name: "Wilmington, DE", image: "/delaware.webp", href: "/business-address/delaware/wilmington/location-942/" },
];

interface PopularBusinessAddressLocationsProps {
  title?: string;
  description?: string;
  count?: number;
  align?: 'left' | 'center';
...
export function PopularBusinessAddressLocations({
  ...
  align = 'left',
  locations,
}: PopularBusinessAddressLocationsProps) {
          ...
          {mobileLocationsData.map((location, index) => (
            ...
            >
              <div className="relative h-[200px] w-full overflow-hidden rounded-lg flex flex-col justify-end">
                <Image
                  src={getImageUrl() + resolveImage(location, index)}
                  alt={location.name}
                  fill
